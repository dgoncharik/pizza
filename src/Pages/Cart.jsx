...
function Cart() {
  ...
  const {pizzasInCart, totalPrice, totalCount} = useSelector(({cart}) => {
    return {
      pizzasInCart: cart.allItems,
  ...
  const pizzaElements = Object.entries(pizzasInCart).map(([id, obj]) => {
    ...
    return <CartItem
        ...
        count={obj.count}
        sum={obj.sum}
        onCartItemPlusCallback={onPlusCartItem}
        onCartItemMinusCallback={onMinusCartItem}
        onCartItemRemoveCallback={onCartItemRemove}
    />
  });
                ...
                <div className="cart">
                  ...
                  <div className="cart__bottom">
                    ...
                    <div className="cart__bottom-buttons">
                      ...
                      <Button onClick={onClickPayNow} className="pay-btn">
